    ...
    public function bodyParameters(): array
    {
        return [
            'name' => [
                ...
                'example' => 'Our Village Heritage Restaurant',
            ],
            'category_id' => [
                'description' => 'The updated subcategory ID link.',
                'example' => 2,
            ],
            'description' => [
                'description' => 'The updated description text.',
                'example' => 'Serving authentic traditional countryside breakfast.',
            ],
            'address' => [
                'description' => 'The updated location address details.',
                'example' => 'Yabroud, Al-Qaa Square',
            ],
            'latitude' => [
                'description' => 'The updated GPS latitude.',
                'example' => 33.9600,
            ],
            'longitude' => [
                'description' => 'The updated GPS longitude.',
                'example' => 36.6500,
            ],
            'price_range' => [
                'description' => 'The updated price classification.',
                'example' => 'Moderate',
            ],
            'status' => [
                'description' => 'The administrative status of the entity listing.',
                'example' => 'approved',
            ],
            'is_verified' => [
                'description' => 'Verification badge flag assigned by system moderators.',
                'example' => true,
            ],
            'images' => [
                'description' => 'Additional image files to append to the active entity gallery.',
                'required' => false,
                'type' => 'file[]',
            ],
            'contacts' => [
            ...
            'contacts.*.value' => [
                'description' => 'The updated address/number for the channel.',
                'required' => true,
            ],
            'working_hours' => [
            ...
            'working_hours.*.day_of_week' => [
                'description' => 'Day representation index (0-6).',
                'required' => true,
            ],
            'working_hours.*.is_closed' => [
                'description' => 'Status of business on this specific day.',
                'required' => true,
            ],
            'working_hours.*.open_time' => [
                'description' => 'Opening shift time (HH:mm format).',
                'required' => false,
            ],
            'working_hours.*.close_time' => [
                'description' => 'Closing shift time (HH:mm format).',
                'required' => false,
            ],
        ];
    }
